...
int main()
{
  ...
  std::string literal = "{\"Name\": \"FirstName LastName\",  \"A_O_T\": 0,  \"Budgets\": [],\"Income\": 0,\"Scores\": [],\"SumDebits\": 0 }";
  USER *user = new USER(literal);

  Transaction test1("Ralphs 1", new Date(1, 1, 2000), 12.34);
  std::cout << test1.addTrans() << "\n";

  Transaction test2("Ralphs 2", new Date(1, 1, 2000), 12.34);

  std::cout << test2.addTrans() << "\n";
