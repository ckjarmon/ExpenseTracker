...
std::cout << u.getUSER_FIELD("Score") << std::endl;
 ...
 std::string user_name = u.getUSERINFO("Name");
        std::string balance = u.getUSERINFO("Balance");
        std::string budget = u.getUSERINFO("Budget");
        std::string  score = yu.getUSERINFO("Score");
}